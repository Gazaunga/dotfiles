...
sudo apt-get -y --allow-unauthenticated install gdm i3 i3blocks dzen2 nautilus mpv tree youtube-dl scrot dmenu xscreensaver python-pip xfce4-power-manager rofi emacs texstudio arandr leafpad fontforge lxappearance feh darktable rxvt-unicode-256color typora clipgrab variety
