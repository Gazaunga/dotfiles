...
touch ~/.xmobarrc
touch ~/.xsessionrc
sudo apt-get -y --allow-unauthenticated install gdm3 texlive-full xmonad xmobar stalonetray thunar libghc-xmonad-contrib-dev cabal-install xcompmgr scrot suckless-tools xscreensaver python-pip xfce4-power-manager moc rofi konsole emacs texstudio arandr leafpad fontforge lxappearance feh darktable rxvt-unicode-256color typora clipgrab variety
