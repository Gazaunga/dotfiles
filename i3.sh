...
mkdir .i3
mkdir i3blocks
pacaur -S xorg-xinit i3-gaps-git i3blocks-git dmenu rofi emacs termite compton thunar gvfs file-roller thunar-archive plugin thunar-shares-plugin thunar-volman ffmpegthumbnailer tumbler raw-thumbnailer gvfs-smb sshfs nitrogen lxappearance pandoc typora mpv texlive-most cmake darktable
cd .i3
