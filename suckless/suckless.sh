...
mkdir dwm
mkdir bin
wget https://raw.githubusercontent.com/Gazaunga/dotfiles/master/suckless/.Xdefaults
wget https://raw.githubusercontent.com/Gazaunga/dotfiles/master/suckless/.conkyrc
wget https://raw.githubusercontent.com/Gazaunga/dotfiles/master/suckless/.xinitrc
mkdir .config
cd .config
mkdir qutebrowser
cd ~/qutebrowser
...
cd ~/
cd dwm
wget https://raw.githubusercontent.com/Gazaunga/dotfiles/master/suckless/config.h
cd ~/
